...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/round-hill-efbf)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/round-hill-efbf
```

A live public deployment of this template is available at [https://round-hill-efbf.templates.workers.dev](https://round-hill-efbf.templates.workers.dev)
